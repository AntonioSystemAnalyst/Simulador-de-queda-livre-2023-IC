...
namespace freeFall
{
    public partial class Table : Form
    {
        ...
        public void loading ()
        {
            ...
            {
                richTextBox.Text += "[" + i + "] ball: " + Program.paperSpaceTable[i] + "- ["+i+"]" + Program.ball.Space[i] + "\n";
            }

            for (i = 0; i < Program.ball.NumberOfTerms+4; i++)
            {
                richTextBox.Text += "[" + i + "] ball: " + Program.ballSpaceTable[i] + "\n";
            }
        }
    }
}
